...
const ContactPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Add hidden year field manually to the form data if needed by template
        // However, emailjs.sendForm sends what is in the form element. 
        // We can add a hidden input for year or just pass it if we were using send instead of sendForm.
        // Since the prompt explicitly asked for `year: number` in the template variable, 
        // we should ensure it's included. 
        // The easiest way with sendForm is to have a hidden input.
